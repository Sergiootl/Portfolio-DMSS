 ...
 * 
 */
package dmss_pa_01.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(dmss_pa_01.diagram.part.Dmss_pa_01DiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(dmss_pa_01.diagram.part.Messages.MessageFormatParser_InvalidInputError,
