...
public class RootEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Dmss_pa_01"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new dmss_pa_01.diagram.edit.policies.RootItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new dmss_pa_01.diagram.edit.policies.RootCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new dmss_pa_01.diagram.edit.commands.Dmss_pa_01CreateShortcutDecorationsCommand(
