 ...
 * @generated
 */
public class TituloUniversitarioNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TituloUniversitarioNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new dmss_pa_01.diagram.edit.policies.Dmss_pa_01TextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return dmss_pa_01.diagram.providers.Dmss_pa_01ElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = dmss_pa_01.diagram.providers.Dmss_pa_01ParserProvider.getParser(
					dmss_pa_01.diagram.providers.Dmss_pa_01ElementTypes.TituloUniversitario_3001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					dmss_pa_01.diagram.edit.parts.Dmss_pa_01EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
