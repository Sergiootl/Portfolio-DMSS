...
public class PreguntaEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new dmss_pa_01.diagram.edit.policies.PreguntaItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof dmss_pa_01.diagram.edit.parts.PreguntaTextoEditPart) {
			((dmss_pa_01.diagram.edit.parts.PreguntaTextoEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePreguntaLabelFigure());
			return true;
		}
		if (childEditPart instanceof dmss_pa_01.diagram.edit.parts.PreguntaPreguntaRespuestasCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getPreguntaRespuestasCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((dmss_pa_01.diagram.edit.parts.PreguntaPreguntaRespuestasCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof dmss_pa_01.diagram.edit.parts.PreguntaPreguntaRespuestasCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getPreguntaRespuestasCompartmentFigure();
			pane.remove(((dmss_pa_01.diagram.edit.parts.PreguntaPreguntaRespuestasCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof dmss_pa_01.diagram.edit.parts.PreguntaPreguntaRespuestasCompartmentEditPart) {
