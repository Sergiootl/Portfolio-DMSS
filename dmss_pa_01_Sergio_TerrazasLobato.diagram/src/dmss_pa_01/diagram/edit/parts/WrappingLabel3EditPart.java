	...
	*/
	static {
		registerSnapBackPosition(dmss_pa_01.diagram.part.Dmss_pa_01VisualIDRegistry
				.getType(dmss_pa_01.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = dmss_pa_01.diagram.providers.Dmss_pa_01ParserProvider.getParser(
					dmss_pa_01.diagram.providers.Dmss_pa_01ElementTypes.ProfesorAsignaturas_4009, getParserElement(),
