	...
	private static class OpenDiagramCommand extends AbstractTransactionalCommand {
		...
		*/
		OpenDiagramCommand(HintedDiagramLinkStyle linkStyle) {
			...
			super(TransactionUtil.getEditingDomain(linkStyle), dmss_pa_01.diagram.part.Messages.CommandName_OpenDiagram,
					null);
						...
						try {
							for (Iterator it = diagramFacet.eResource().getResourceSet().getResources().iterator(); it
								...
								if (nextResource.isLoaded() && !getEditingDomain().isReadOnly(nextResource)) {
									nextResource
											.save(dmss_pa_01.diagram.part.Dmss_pa_01DiagramEditorUtil.getSaveOptions());
								}
							}
