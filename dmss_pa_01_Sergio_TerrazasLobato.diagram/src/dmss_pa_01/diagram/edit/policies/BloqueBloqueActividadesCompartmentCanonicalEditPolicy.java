 ...
 * @generated
 */
public class BloqueBloqueActividadesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return dmss_pa_01.Dmss_pa_01Package.eINSTANCE.getBloque_Actividades();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<dmss_pa_01.diagram.part.Dmss_pa_01NodeDescriptor> childDescriptors = dmss_pa_01.diagram.part.Dmss_pa_01DiagramUpdater
				.getBloqueBloqueActividadesCompartment_7007SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		int visualID = dmss_pa_01.diagram.part.Dmss_pa_01VisualIDRegistry.getVisualID(view);
		switch (visualID) {
	...
	*/
	protected void refreshSemantic() {
		...
		List<dmss_pa_01.diagram.part.Dmss_pa_01NodeDescriptor> childDescriptors = dmss_pa_01.diagram.part.Dmss_pa_01DiagramUpdater
				.getBloqueBloqueActividadesCompartment_7007SemanticChildren((View) getHost().getModel());
