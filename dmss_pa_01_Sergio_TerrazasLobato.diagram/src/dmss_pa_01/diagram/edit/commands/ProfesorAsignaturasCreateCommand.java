 ...
 * @generated
 */
public class ProfesorAsignaturasCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ProfesorAsignaturasCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return dmss_pa_01.diagram.edit.policies.Dmss_pa_01BaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateProfesorAsignaturas_4009(getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getAsignaturas().add(getTarget());
		}
