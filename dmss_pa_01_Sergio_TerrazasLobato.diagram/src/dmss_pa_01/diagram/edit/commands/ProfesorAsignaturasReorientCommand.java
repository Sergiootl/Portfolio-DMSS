 ...
 * @generated
 */
public class ProfesorAsignaturasReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ProfesorAsignaturasReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return dmss_pa_01.diagram.edit.policies.Dmss_pa_01BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistProfesorAsignaturas_4009(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return dmss_pa_01.diagram.edit.policies.Dmss_pa_01BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistProfesorAsignaturas_4009(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getAsignaturas().remove(getOldTarget());
		getNewSource().getAsignaturas().add(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getAsignaturas().remove(getOldTarget());
		getOldSource().getAsignaturas().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
