 ...
 * @generated
 */
public class Dmss_pa_01ShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = dmss_pa_01.diagram.part.Dmss_pa_01DiagramEditorPlugin.getInstance()
