 ...
 * @generated
 */
public class Dmss_pa_01MarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = dmss_pa_01.diagram.part.Dmss_pa_01DiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			dmss_pa_01.diagram.part.Dmss_pa_01DiagramEditorUtil.selectElementsInDiagram(editor,
