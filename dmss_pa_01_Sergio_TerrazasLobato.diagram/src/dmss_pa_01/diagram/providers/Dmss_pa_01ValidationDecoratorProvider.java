 ...
 * @generated
 */
public class Dmss_pa_01ValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = dmss_pa_01.diagram.part.Dmss_pa_01DiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof dmss_pa_01.diagram.part.Dmss_pa_01DiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && dmss_pa_01.diagram.edit.parts.RootEditPart.MODEL_ID
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				dmss_pa_01.diagram.part.Dmss_pa_01DiagramEditorPlugin.getInstance().logError("ViewID access failure", //$NON-NLS-1$
						e);
			}
		}
