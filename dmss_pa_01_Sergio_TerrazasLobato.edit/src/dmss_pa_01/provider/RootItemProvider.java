...
/**
 * This is the item provider adapter for a {@link dmss_pa_01.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Dmss_pa_01Package.Literals.ROOT__UNIVERSIDAD);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Root.class)) {
			case Dmss_pa_01Package.ROOT__UNIVERSIDAD:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Dmss_pa_01Package.Literals.ROOT__UNIVERSIDAD,
				 Dmss_pa_01Factory.eINSTANCE.createUniversidad()));
	}
