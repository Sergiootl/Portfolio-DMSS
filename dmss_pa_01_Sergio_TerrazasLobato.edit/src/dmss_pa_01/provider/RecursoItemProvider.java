...
/**
 * This is the item provider adapter for a {@link dmss_pa_01.Recurso} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecursoItemProvider extends ActividadItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recurso_Extension_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recurso_Extension_feature", "_UI_Recurso_type"),
				 Dmss_pa_01Package.Literals.RECURSO__EXTENSION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Recurso_type") + " " + recurso.getID();
	}
