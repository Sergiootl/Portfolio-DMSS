 ...
 * </p>
 * <ul>
 *   <li>{@link dmss_pa_01.impl.PreguntaImpl#getRespuestas <em>Respuestas</em>}</li>
 *   <li>{@link dmss_pa_01.impl.PreguntaImpl#getTexto <em>Texto</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PreguntaImpl extends EObjectImpl implements Pregunta {
	...
	protected EClass eStaticClass() {
		return Dmss_pa_01Package.Literals.PREGUNTA;
	}
	...
	public EList<Respuesta> getRespuestas() {
		if (respuestas == null) {
			respuestas = new EObjectContainmentEList<Respuesta>(Respuesta.class, this, Dmss_pa_01Package.PREGUNTA__RESPUESTAS);
		}
		return respuestas;
	}
	...
	public void setTexto(String newTexto) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dmss_pa_01Package.PREGUNTA__TEXTO, oldTexto, texto));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Dmss_pa_01Package.PREGUNTA__RESPUESTAS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Dmss_pa_01Package.PREGUNTA__TEXTO:
				return getTexto();
		}
